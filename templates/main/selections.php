...
<script>
  ...
  $(document).on("click",".serviceBLk", function(){
	...
	$.each(filteredPictureTypes, function(key, value) {
		$types = "<div class='col-10 pb-1'><input type='radio' id='pictureType' name='pictureTypeRadio' value='"+value.id+"' data-price='"+value.price+"'> <label>"+value.title+"</label></div><div class='col-2 p-0' style='font-size: 10px;align-content: center;'>"+<?php echo numTo3Float( ?>value.price<?php ); ?>+" -/KD</div>";
