<div class="row py-3 m-0">
	<div class="col-6" style="text-align: -webkit-center;"><img src="<?php echo "logos/{$vendor["logo"]}" ?>" class="heroLogo"></div>
	<div class="col-6" style="text-align: -webkit-center;"><?php echo direction($vendor["enDetails"],$vendor["arDetails"]) ?></div>
