<div class="row py-3 m-0">
	<div class="col-sm-2 col-12" style="text-align: -webkit-center;"><img src="<?php echo "logos/{$vendor["logo"]}" ?>" class="heroLogo"></div>
	<div class="col-sm-10 col-12" ><?php echo direction($vendor["enDetails"],$vendor["arDetails"]) ?></div>
